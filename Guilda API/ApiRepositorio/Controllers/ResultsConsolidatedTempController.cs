...
{
    //[Authorize]
    public class ResultsConsolidatedTempController : ApiController
    {
        ...
        public IHttpActionResult PostResultsModel(long t_id, IEnumerable<Result> results)
        {
            ...
            //ResultsConsolidatedController.ReturnBasketIndicatorUser biu = ResultsConsolidatedController.returnIndicatorUserMonetization("768668", lbasket, lgroup);

            //ResultsConsolidatedController.attUser(biu.idGroup, user.idTable);

            //ScheduledTask.processoSemanalMensal();
        ...
        public bool monetization(int transactionID)
        {
            ...
            datas.Add("2024-03-01");
            datas.Add("2024-03-02");
            datas.Add("2024-03-03");
            datas.Add("2024-03-04");
            datas.Add("2024-03-05");
            datas.Add("2024-03-06");
            datas.Add("2024-03-07");
            datas.Add("2024-03-08");
            datas.Add("2024-03-09");
            datas.Add("2024-03-10");
            datas.Add("2024-03-11");
            datas.Add("2024-03-12");
            datas.Add("2024-03-13");
            datas.Add("2024-03-14");
            ...
            foreach (string dt in datas)
            {
                ...
                using (SqlConnection connection = new SqlConnection(Database.Conn))
                {
                    ...
                    try
                    {
                        ...
                        stb.Append("ELSE IDGDA_SECTOR END AS IDGDA_SECTOR ");
        ...
        public List<MonetizationHierarchy> getMonetizationHierarchyNew(string dateM, string idEnv, string idIndicador)
        {
            ...
            using (SqlConnection connection = new SqlConnection(Database.Conn))
            {
                try
                {
                    ...
                    //stb.Append("       END) - ");
                    //stb.Append("       (CASE  ");
                    //stb.Append("            WHEN SUM(OUTPUT) IS NULL THEN 0 ");
                    //stb.Append("            ELSE SUM(OUTPUT) ");
                    //stb.Append("       END) AS SOMA  ");
