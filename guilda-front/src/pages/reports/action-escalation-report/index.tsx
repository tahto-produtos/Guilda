      ...
      .then((data) => {
        ...
        const docRows = data.map((item: any) => {
          return [
            ...
            item.DIRETOR,
            item.CEO,
            item.DISPERSAO_RESULTADO,
            item.RESULTADO_STATUS,
            item.DIFERENCA_META,
            item.ACAO_DETALHADO,
            item.DATA_INICIO,
            item.DATA_FIM,
        ...
        indicatorSheetBuilder
          ...
          .append(docRows)
          .exportAs(`Relatório_Plano_de_Ação`);
        ...
        <Stack px={"40px"}>
          ...
          <Stack direction={"row"} gap="16px">
            <Autocomplete
              ...
              fullWidth
              onInputChange={(e, text) => setSectorsSearchValueSub(text)}
              renderInput={(props) => (
                <TextField
                  {...props}
                  variant="outlined"
