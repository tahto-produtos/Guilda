...
import { MassiveSectorsImportUseCase } from "src/modules/sectors/use-cases/massive-sectors-import.use-case";
...
export default function MassiveImport() {
    ...
    const sendFile = async () => {
        ...
        new MassiveSectorsImportUseCase()
            .handle(file)
            .then((data) => {
    ...
    function downloadExampleFile() {
        try {
            const docRows = [
                ["5633214", "Novo nome", "2;3", "Abs Humano;Localizadas"],
            ];
            ...
            indicatorSheetBuilder
                .setHeader([
                    "COD GIP",
                    "NOME DO SETOR",
                    "CÓDIGO DO INDICADOR (separado por ;)",
                    "NOME DO INDICADOR (separado por ;)",
                ])
                .append(docRows)
                .exportAs(`Exemplo_importação_massiva_setores`);
...
MassiveImport.getLayout = getLayout("private");
