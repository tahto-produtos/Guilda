...
{
    //[Authorize]
    public class LoggedAccountsController : ApiController
    {// POST: api/Results
        [HttpGet]
        public IHttpActionResult PostResultsModel(int limit, int page)
        {
            ...
            rmams = returnTables.listMyAccounts(collaboratorId.ToString(), personauserId, limit, page);
