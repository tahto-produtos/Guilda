...
{
    //[Authorize]
    public class ActivatedNotificationController : ApiController
    {// POST: api/Results
        ...
        public IHttpActionResult PostResultsModel([FromBody] InputModel inputModel)
        {
            ...
            string dtInicial = inputModel.STARTED_AT != null ? inputModel.STARTED_AT?.ToString("yyyy-MM-dd HH:mm:ss") : DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
            string dtFinal = inputModel.ENDED_AT != null ? inputModel.ENDED_AT?.ToString("yyyy-MM-dd HH:mm:ss") : null;
            ...
            {
                UpdateNotification.Append($", ENDED_AT =  NULL ");
            }
