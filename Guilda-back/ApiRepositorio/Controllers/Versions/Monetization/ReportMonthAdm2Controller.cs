...
{
    //[Authorize]
    public class ReportMonthAdm2Controller : ApiController
    {
        ...
        // POST: api/Results
        public static List<returnResponseADM> relMonMensal(string dtInicial, string dtFinal, string groupsAsString, string sectorsAsString, string hierarchiesAsString, string indicatorsAsString, string indicatorsCestaAsString, string colaboratorsAsString, string orderFil, bool Thread = false)
        {
        ...
        public IHttpActionResult PostResultsModel([FromBody] InputModel inputModel)
        {
            ...
            var jsonData = relMonMensal(dtInicial, dtFinal, groupsAsString, sectorsAsString, hierarchiesAsString, indicatorsAsString, indicatorsCestaAsString, colaboratorsAsString, order);
